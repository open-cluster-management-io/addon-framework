...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConfigGR) DeepCopyInto(out *ConfigGR) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigGR.
func (in *ConfigGR) DeepCopy() *ConfigGR {
	if in == nil {
		return nil
	}
	out := new(ConfigGR)
