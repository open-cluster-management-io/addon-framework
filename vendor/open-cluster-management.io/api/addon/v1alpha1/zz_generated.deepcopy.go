...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConfigGVR) DeepCopyInto(out *ConfigGVR) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigGVR.
func (in *ConfigGVR) DeepCopy() *ConfigGVR {
	if in == nil {
		return nil
	}
	out := new(ConfigGVR)
...
func (in *ManagedClusterAddOnStatus) DeepCopyInto(out *ManagedClusterAddOnStatus) {
	*out = *in
	...
	out.AddOnMeta = in.AddOnMeta
	out.AddOnConfiguration = in.AddOnConfiguration
	out.ConfigReference = in.ConfigReference
