...
import (
	...
	cloudeventsgeneric "open-cluster-management.io/sdk-go/pkg/cloudevents/generic"
...
func (a *cloudeventsAddonManager) Start(ctx context.Context) error {
	...
	_, clientConfig, err := cloudeventsgeneric.NewConfigLoader(a.options.WorkDriver, a.options.WorkDriverConfig).
