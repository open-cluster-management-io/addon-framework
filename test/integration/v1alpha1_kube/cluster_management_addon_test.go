...
var _ = ginkgo.Describe("ClusterManagementAddon", func() {
	...
	// Skipped: This test requires CRD conversion webhooks which are not available in envtest.
	ginkgo.It("Should update config related object successfully", func() {
		ginkgo.Skip("Requires CRD conversion webhook - not available in envtest")
