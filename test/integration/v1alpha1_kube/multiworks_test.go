...
var _ = ginkgo.Describe("Agent deploy multi works", func() {
	...
	ginkgo.It("Should deploy agent successfully", func() {
		...
		testMultiWorksAddonImpl.prober = &agentv1alpha1.HealthProber{
	...
	ginkgo.It("Should deploy agent and get available with prober func", func() {
		...
		testMultiWorksAddonImpl.prober = newV1alpha1DeploymentProber(
			types.NamespacedName{Name: "nginx-deployment-0", Namespace: "default"},
